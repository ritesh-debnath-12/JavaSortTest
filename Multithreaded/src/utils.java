...
public class utils {
    ...
    public static void processFile(int fileIndex, ThreeArgsSort sorting_function){
        try{
            long startTime = System.nanoTime();
            int [][] arr = utils.parseArrayFromFile("input" + fileIndex + ".txt");

            File file = new File("output/bubble/output" + fileIndex + ".txt");
    ...
    public static void processFile(int fileIndex, OneArgSort sorting_function){
        try{
            long startTime = System.nanoTime();
            int [][] arr = utils.parseArrayFromFile("input" + fileIndex + ".txt");
